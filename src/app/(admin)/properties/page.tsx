...
export default function PropertiesPage() {
    ...
    return (
        <div className="space-y-6">
                                    ...
                                    <div className="grid grid-cols-3 gap-6">
                                        ...
                                        <div>
                                            ...
                                            {homestead.squareFeet && (
                                                <p className="text-sm">
                                                    {homestead.squareFeet.toLocaleString()}{' '}
                                                    sq ft
                                                </p>
                                            )}
                                            {homestead.yearBuilt && (
            ...
            <ResourceDialog
                open={homesteadForm.isOpen}
                onOpenChange={homesteadForm.close}
                title={
                    homesteadForm.isEditing ? 'Edit Homestead' : 'Add Homestead'
                }
                onSubmit={homesteadForm.handleSave}
                isLoading={homesteadForm.isSubmitting}
            >
                <div className="space-y-6">
                    <div>
