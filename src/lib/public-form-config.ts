...
export const ASSET_TYPES: AssetTypeConfig[] = [
  ...
  },
  {
    ...
    fields: [
      { name: "name", label: "Item Name", type: "text", required: true, placeholder: "Sterling Silver Fork" },
      {
        name: "category",
        label: "Category",
        type: "select",
      ...
      { name: "location", label: "Location", type: "text", placeholder: "Where is this item located?" },
  ...
  },
  {
    ...
    fields: [
      { name: "institution", label: "Bank/Institution", type: "text", required: true, placeholder: "Chase Bank" },
      {
        name: "accountType",
        label: "Account Type",
        type: "select",
      ...
      { name: "accountNumber", label: "Account Number (Last 4 digits)", type: "text", placeholder: "****1234 (optional)" },
  ...
  },
  {
    ...
    fields: [
      { name: "institution", label: "Institution", type: "text", required: true, placeholder: "Fidelity" },
      {
        name: "accountType",
        label: "Account Type",
        type: "select",
      ...
      { name: "accountNumber", label: "Account Number (Last 4 digits)", type: "text", placeholder: "****5678 (optional)" },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "carrier", label: "Insurance Carrier", type: "text", required: true, placeholder: "State Farm" },
      { name: "policyNumber", label: "Policy Number", type: "text", required: true, placeholder: "POL-123456" },
      { name: "coverageAmount", label: "Coverage Amount", type: "number", placeholder: "500000.00" },
      { name: "notes", label: "Additional Notes", type: "textarea" },
    ],
  },
  {
    ...
    fields: [
      { name: "streetAddress", label: "Street Address", type: "text", required: true, placeholder: "123 Main St" },
  ...
  },
  {
    ...
    fields: [
      { name: "name", label: "Property Name", type: "text", required: true, placeholder: "Oak Street Rental" },
      { name: "streetAddress", label: "Street Address", type: "text", required: true, placeholder: "456 Oak St" },
  ...
  },
  {
    ...
    fields: [
      { name: "title", label: "Title", type: "text", required: true, placeholder: "Sunset Landscape" },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "creditor", label: "Creditor/Lender", type: "text", required: true, placeholder: "Bank of America" },
      { name: "originalAmount", label: "Original Amount", type: "number", required: true, placeholder: "250000.00" },
      { name: "currentBalance", label: "Current Balance", type: "number", placeholder: "185000.00 (optional)" },
