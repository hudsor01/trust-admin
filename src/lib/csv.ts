...
/**
 * Today's date as a LOCAL-time `YYYY-MM-DD` string (not UTC). Use for CSV
 * download filenames — clicking Export at 10 PM Central would otherwise
 * stamp tomorrow's UTC date.
 */
