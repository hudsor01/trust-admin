...
export type AllocationClass = 'PRINCIPAL' | 'INCOME'
...
export function isPrincipalTransaction(
  ...
  return classifyTransaction(incomeType, expenseType, category) === 'PRINCIPAL'
}
...
export function getClassificationReason(
  ...
  const classification = classifyTransaction(incomeType, expenseType, category)
...
export function getIncomeTypeOptions(): Array<{
  ...
  return [
    ...
    { value: 'CAPITAL_GAIN', label: 'Capital Gain', classification: 'PRINCIPAL' },
    { value: 'SALE_PROCEEDS', label: 'Sale Proceeds', classification: 'PRINCIPAL' },
    { value: 'DISTRIBUTION', label: 'Distribution (from entity)', classification: 'PRINCIPAL' },
...
export function getExpenseTypeOptions(): Array<{
  ...
  return [
    ...
    { value: 'MAINTENANCE', label: 'Maintenance', classification: 'INCOME' },
    { value: 'REPAIR', label: 'Repairs', classification: 'INCOME' },
    { value: 'UTILITY', label: 'Utilities', classification: 'INCOME' },
    { value: 'PROFESSIONAL_FEE', label: 'Professional Fees', classification: 'INCOME' },
    { value: 'TRUSTEE_FEE', label: 'Trustee Fee', classification: 'INCOME' },
