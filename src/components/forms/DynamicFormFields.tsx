...
export function DynamicFormFields({ config, values, onChange }: DynamicFormFieldsProps) {
  const renderField = (field: FormField) => {
    ...
    return (
      <div key={field.name} className="space-y-2">
        ...
        {field.type === "text" && <Input {...commonProps} type="text" />}

        {field.type === "number" && <Input {...commonProps} type="number" step="0.01" />}
