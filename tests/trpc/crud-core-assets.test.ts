    ...
    () => {
        ...
        afterAll(async () => {
            ...
            if (testIds.artworkId)
                await db
                    .delete(artwork)
                    .where(eq(artwork.id, testIds.artworkId))
            ...
            if (testIds.vehicleId)
                await db
                    .delete(vehicle)
                    .where(eq(vehicle.id, testIds.vehicleId))
            ...
            if (testIds.investmentAccountId)
                await db
                    ...
                    .where(
                        eq(investmentAccount.id, testIds.investmentAccountId),
                    )
        ...
        describe('task', () => {
            ...
            test(
                ...
                async () => {
                    ...
                    expect(Array.isArray(results)).toBe(true)
                    expect(results.some((r) => r.id === testIds.taskId)).toBe(
                        true,
                    )
                },
                TEST_TIMEOUT,
        ...
        describe('investmentAccount', () => {
            ...
            test(
                ...
                async () => {
                    ...
                    expect(
                        results.some(
                            (r) => r.id === testIds.investmentAccountId,
                        ),
                    ).toBe(true)
                },
                TEST_TIMEOUT,
        ...
        describe('homestead', () => {
            ...
            test(
                ...
                async () => {
                    ...
                    expect(Array.isArray(results)).toBe(true)
                    expect(
                        results.some((r) => r.id === testIds.homesteadId),
                    ).toBe(true)
                },
                TEST_TIMEOUT,
            )
        ...
        describe('vehicle', () => {
            ...
            test(
                ...
                async () => {
                    ...
                    expect(Array.isArray(results)).toBe(true)
                    expect(
                        results.some((r) => r.id === testIds.vehicleId),
                    ).toBe(true)
                },
                TEST_TIMEOUT,
            )
        ...
        describe('personalProperty', () => {
            ...
            test(
                ...
                async () => {
                    ...
                    expect(
                        results.some(
                            (r) => r.id === testIds.personalPropertyId,
                        ),
                    ).toBe(true)
                },
                TEST_TIMEOUT,
        ...
        describe('artwork', () => {
            ...
            test(
                ...
                async () => {
                    ...
                    expect(Array.isArray(results)).toBe(true)
                    expect(
                        results.some((r) => r.id === testIds.artworkId),
                    ).toBe(true)
                },
                TEST_TIMEOUT,
            )
