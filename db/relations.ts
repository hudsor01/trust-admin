...
import { entity, vehicle, homestead, rentalProperty, bankAccount, investmentAccount, insurancePolicy, beneficiary, distribution, valuation, personalProperty, document, transaction, contact, contactAssociation, task, artwork, trustee, specificBequest, trustAccounting, withdrawalRecord, hemsRequest, trusteeFeeSchedule, trusteeFeeEntry } from "./schema";
...
export const rentalPropertyRelations = relations(rentalProperty, ({one, many}) => ({
	entity: one(entity, {
...
export const personalPropertyRelations = relations(personalProperty, ({one, many}) => ({
	entity: one(entity, {
...
export const contactAssociationRelations = relations(contactAssociation, ({one}) => ({
	contact: one(contact, {
...
export const specificBequestRelations = relations(specificBequest, ({one}) => ({
	entity: one(entity, {
...
export const trustAccountingRelations = relations(trustAccounting, ({one}) => ({
	entity: one(entity, {
...
export const withdrawalRecordRelations = relations(withdrawalRecord, ({one}) => ({
	beneficiary: one(beneficiary, {
...
export const trusteeFeeScheduleRelations = relations(trusteeFeeSchedule, ({one, many}) => ({
	entity: one(entity, {
...
export const trusteeFeeEntryRelations = relations(trusteeFeeEntry, ({one}) => ({
	entity: one(entity, {
