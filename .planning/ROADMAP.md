...
<details>
<summary>✅ v3.0 Database Schema Improvements (Phases 18-24) — SHIPPED 2026-01-18</summary>

See: [milestones/v3.0-ROADMAP.md](milestones/v3.0-ROADMAP.md) for full details.

**Key accomplishments:**
- Migrated 116 timestamp columns to TIMESTAMPTZ for timezone safety
- Added 5 pgEnums for database-level type validation
- Added CHECK constraints to 3 polymorphic tables (21 FK columns validated)
- Added 3 composite indexes for query performance
- Migrated 27 tables from TEXT to BIGINT IDENTITY primary keys
- Renamed 27 tables from PascalCase to snake_case

**Phases:**
- [x] Phase 18: Timestamp Migration (1 plan)
- [x] Phase 19: Enum Type Corrections (1 plan)
- [x] Phase 20: Polymorphic Constraints (1 plan)
- [x] Phase 21: Composite Indexes (1 plan)
- [x] Phase 22: Nullable FK Review (1 plan)
- [x] Phase 23: PK Type Migration (3 plans)
- [x] Phase 24: Table Naming Convention (1 plan)
